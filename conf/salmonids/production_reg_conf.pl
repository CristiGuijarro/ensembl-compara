...
my $compara_dbs = {
    # general compara dbs
    'compara_master' => [ 'mysql-ens-compara-prod-9', 'muffato_ensembl_compara_master_salmonids' ],
    ...
    # LASTZ dbs
    'lastz_batch_1'    => [ 'mysql-ens-compara-prod-10', 'muffato_salmonids_lastz_103' ],
    'lastz_batch_2'    => [ 'mysql-ens-compara-prod-8', 'cristig_salmon_lastz_batch2_103' ],
    #'lastz_batch_3'    => [ 'mysql-ens-compara-prod-8', 'cristig_salmon_lastz_batch3_103' ],
    # EPO dbs

    ## salmonids
     'salmonids_epo_anchors'  => [ 'mysql-ens-compara-prod-10', 'cristig_generate_anchors_small-salmonids_104' ],
     'salmonids_epo_high_low' => [ 'mysql-ens-compara-prod-9', 'cristig_salmonids_epo_with_ext_104' ],
    ...
    # 'salmonids_epo_prev'     => [ 'mysql-ens-compara-prod-7', 'jalvarez_fish_epo_update_103' ],
...
my $ancestral_dbs = {
    ...
    'salmonids_ancestral'   => [ 'mysql-ens-compara-prod-9', 'cristig_salmonids_ancestral_core_104' ],
};
